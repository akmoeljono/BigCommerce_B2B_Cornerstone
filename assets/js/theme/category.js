...
export default class Category extends CatalogPage {
    ...
    onReady() {
        ...
        const sameLevelCategories = this.findCategoriesAtSameLevelByName(this.context.allCategories, this.context.currentCategoryId.toString());
    ...
    findCategoriesAtSameLevelByName(categoryTree, currentCategoryId) {
        let categoriesAtSameLevel = [];
